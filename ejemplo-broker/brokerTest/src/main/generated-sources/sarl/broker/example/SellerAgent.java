...
public class SellerAgent extends Agent {
  ...
  private final long stock = 10;
  
  private double value = 1.0;
  
  private String product = "Computadora";
  
  private ArrayList<String> productos = CollectionLiterals.<String>newArrayList("Computadora", "Monitor", "Mouse", "Teclado");
  ...
  private void $behaviorUnit$QueryEventOnSellers$1(final QueryEventOnSellers occurrence) {
    ...
    if (_equals) {
      ...
      SellerAnswer _sellerAnswer = new SellerAnswer(sku, this.value);
      _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_sellerAnswer);
    }
  }
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$QueryEventOnSellers(final QueryEventOnSellers occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$QueryEventOnSellers$1(occurrence));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SellerAgent other = (SellerAgent) obj;
  ...
  @SyntheticMember
  public SellerAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public SellerAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public SellerAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
